...
def inserir_cliente(request):
    if request.method == "POST":
        ...
        from_endereco = EnderecoForm(request.POST)
        if form_cliente.is_valid():
            ...
            if from_endereco.is_valid():
                rua = from_endereco.cleaned_data["rua"]
                numero = from_endereco.cleaned_data["numero"]
                complemento = from_endereco.cleaned_data["complemento"]
                bairro = from_endereco.cleaned_data["bairro"]
                cidade = from_endereco.cleaned_data["cidade"]
                pais = from_endereco.cleaned_data["pais"]
                ...
                cliente_novo = cliente.Cliente(nome=nome, sobrenome=sobrenome, sexo=sexo, data_nascimento=data_nascimento,
...
def listar_client_id(request, id):
